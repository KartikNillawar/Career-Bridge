package com.kartikCode.CareerBridge.services;


import com.kartikCode.CareerBridge.entity.*;
import com.kartikCode.CareerBridge.repository.JobPostActivityRepository;
import com.kartikCode.CareerBridge.repository.JobSeekerApplyRepository;
...
public class JobPostActivityService {
    ...
    public void deletejob(int id) {
        ...
        List<JobSeekerApply> applies = jobSeekerApplyRepository.findByJob(jobPostActivity);
        for(JobSeekerApply current: applies)
        {
            jobSeekerApplyRepository.delete(current);
        }
